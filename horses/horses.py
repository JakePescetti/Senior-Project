...
def EngineOn():
	...
	traci.start([sumoBinary, "-c", "horses.sumocfg", "--ignore-route-errors",
							 "--full-output", "tripinfo.xml", "--emission-output", "emissions.xml"])
	run()
...
def generate_routefile():
	...
	with open("horses.rou.xml", "w") as routes:
		...
		<route id="bike1" edges=":5541152569_0 50439396#0 50439396#1 50439396#2 -13373927#2 -13373927#1 -13373927#0 -13275797#2"/>""", file=routes)
